                                    ...
                                    <div class="item slick-slide">
                                        <div class="item-content">
                                            <div class="content-image">
                                                <img width="1920" height="671" src="<?php echo $image; ?>" alt="Image Slider">
                                            </div>
                                            <div class="item-info horizontal-start vertical-middle">
                                                <div class="content">
                                                    <h2 class="title-slider"><?php echo $title; ?></h2>
                                                    <div class="description-slider"><?php echo $description; ?></div>
                                                    <a class="button button-slider button-white" href="<?php echo $button['url']?>"><?php echo $button['title']; ?></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<section class="section section-padding m-b-0 p-t-100 p-b-100 categories">
            ...
            <div class="block-widget-wrap">
                ...
                <div class="block-content">
                    <div class="product-cats-list slick-wrap">
                        <div class="slick-sliders content-category" 
                            data-dots="0" 
                        ...
                        $categories = get_terms( array(
                            'taxonomy'   => 'product_cat', // WooCommerce Category
                            'hide_empty' => true, // Empty Category Hide
                        ));
                        ...
                        if ( ! empty( $categories ) && ! is_wp_error( $categories ) ) :
                            foreach ( $categories as $category ) :
                                ...
                                // Check if image exists, if not, set a placeholder image
                                if(!$image_url){
                                    $image_url = get_template_directory_uri().'/media/product/placeholder.png';
                                }
                        ...
                        <section class="section background-img bg-img-1 m-b-70">
                            ...
                            <div class="block block-intro">
                                <div class="row">
                                <?php
                                    if( have_rows('handcrafted_block_section') ):
                                    while ( have_rows('handcrafted_block_section') ) : the_row();
                                    $title = get_sub_field('title');
                                        ...
                                        <div class="intro-wrap">
                                                ...
                                                <div class="icon">
                                                    <span class="wrap animation-horizontal">
                                                        <svg xmlns="http://www.w3.org/2000/svg" id="Capa_1"
                                                            height="100%" viewBox="0 0 512.001 512.001" width="100%">
                                                            <g>
                                                                <g>
                                                                    <g>
                                                                        <g>
                                                                            <path
                                                                                d="m479.371 131.029c-3.099 0-6.154-1.436-8.11-4.139-3.236-4.475-2.233-10.727 2.241-13.963l22.638-16.376c4.475-3.239 10.727-2.233 13.964 2.241 3.236 4.475 2.233 10.727-2.241 13.963l-22.638 16.376c-1.772 1.281-3.823 1.898-5.854 1.898z">
                                                                            </path>
                                                                        </g>
                                                                    </g>
                                                                    <g>
                                                                        <g>
                                                                            <path
                                                                                d="m32.63 131.029c-2.032 0-4.082-.617-5.854-1.898l-22.637-16.376c-4.475-3.237-5.478-9.488-2.241-13.963 3.238-4.474 9.49-5.478 13.964-2.241l22.638 16.375c4.475 3.237 5.478 9.488 2.241 13.963-1.956 2.703-5.012 4.14-8.111 4.14z">
                                                                            </path>
                                                                        </g>
                                                                    </g>
                                                                    <g>
                                                                        <g>
                                                                            <path
                                                                                d="m256.001 49.025c-5.522 0-10-4.477-10-10v-23.867c0-5.523 4.478-10 10-10s10 4.477 10 10v23.866c0 5.523-4.478 10.001-10 10.001z">
                                                                            </path>
                                                                        </g>
                                                                    </g>
                                                                    <g>
                                                                        ...
                                                                        <g>
                                                                            <path
                                                                                d="m256.18 230.291c-4.12 0-7.897-2.638-9.35-6.483-1.491-3.948-.269-8.58 3.006-11.255 3.235-2.643 7.897-2.987 11.481-.842 3.583 2.144 5.496 6.426 4.674 10.529-.924 4.61-5.103 8.051-9.811 8.051z">
                                                                            </path>
                                                                        </g>
                                                                    </g>
                                                                </g>
                                            ...
                                            <div class="intro-btn">
                                                <a href="<?php echo $button['url']?>"
                                                    class="button button-black button-arrow animation-horizontal"><?php echo $button['title']?></a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <section class="section section-padding p-t-70 p-b-70">
    <div class="section-container large">
        <!-- Block Banners (Layout 2) -->
        <div class="block block-banners layout-2 banners-effect">
            <div class="block-widget-wrap">
                <?php if( have_rows('collection_section') ): ?>
                <div class="row">
                    <?php while ( have_rows('collection_section') ) : the_row();
                        $title = get_sub_field('title');
                        $description = get_sub_field('description');
                        $button = get_sub_field('button');
                        $image = get_sub_field('image');
...
<section class="section section-padding top-border p-t-100 p-b-120 m-b-0">
    <div class="section-container large">
        <!-- Block Products -->
            ...
            <div class="block-widget-wrap">
                ...
                <div class="block-content">
                    <div class="content-product-list slick-wrap">
                                            ...
                                            <div class="product-thumb-hover">
                                                <a href="<?php the_permalink(); ?>">
                                                    <img width="600" height="600"
                                                        ...
                                                        class="post-image" alt="<?php the_title(); ?>" />
                                                    <img width="600" height="600"
                                                        src="<?php echo get_the_post_thumbnail_url(get_the_ID(), 'medium'); ?>"
                                                        class="hover-image back" alt="<?php the_title(); ?>" />
                                                </a>
                                            </div>
                                        </div>
                        ...
                        <?php if( have_rows('block_parallax_section') ): ?>
    <?php while ( have_rows('block_parallax_section') ) : the_row();
        $description = get_sub_field('description');
        $button = get_sub_field('button');
        $image = get_sub_field('image');
    ?>
    <!-- Block Parallax -->
    <div class="block block-parallax right-text" style="background-image: url('<?php echo $image; ?>'); background-size: cover; background-position: center;">
        <div class="section-container">
            <div class="row">
                <div class="col-md-12">
                    <div class="content">
                        ...
                        <?php if( $button ): ?>
                            <a class="button button-white button-outline thick-border button-arrow animation-horizontal"
                                href="<?php echo $button['url']; ?>">
                                <?php echo $button['title']; ?>
                            </a>
                        <?php endif; ?>
                        ...
                        <section class="section section-padding background-img bg-img-3 p-t-70 p-b-70 m-b-0">
                            <div class="section-container">
                                ...
                                <div class="block block-feature layout-2">
                                    <div class="block-widget-wrap">
                                        <div class="row">
                                        <?php if( have_rows('block_feature_section') ): ?>
                                  <?php while ( have_rows('block_feature_section') ) : the_row();
                                    $description = get_sub_field('description');
                                    $title = get_sub_field('title');
                                    $image = get_sub_field('image');
                                       ?>
